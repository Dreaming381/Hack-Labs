...
namespace Dragons
{
    ...
    public struct DancerReferenceGroupSourcePrefab : IComponentData
    {
        public UnityObjectRef<GameObject> dancerGoPrefab;
        public int                        bonesPerReference;
    }

    public partial struct DancerReferenceGroupTransforms : ICollectionComponent
    {
